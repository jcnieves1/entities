...
return [
    ...
    'online_users_hint' => 'Muestra cada cuenta de usuario y si tiene actualmente una sesión activa en la aplicación. Esta página se actualiza automáticamente.',
    'time_years_one' => 'hace %d año',
    'time_years_other' => 'hace %d años',
    'time_months_one' => 'hace %d mes',
    'time_months_other' => 'hace %d meses',
    'time_days_one' => 'hace %d día',
    'time_days_other' => 'hace %d días',
    'time_hours_one' => 'hace %d hora',
    'time_hours_other' => 'hace %d horas',
    'time_minutes_one' => 'hace %d minuto',
    'time_minutes_other' => 'hace %d minutos',
    ...
    // Admin: condiciones para habilitar campos
    'conditions' => 'Condiciones',
    'field_conditions' => 'Condiciones del campo',
    'field_conditions_hint' => 'Opcionalmente, habilita este campo solo cuando se cumplan ciertas condiciones. Agrega uno o más grupos de condiciones abajo: un grupo coincide cuando TODAS sus condiciones son verdaderas (Y); el campo se habilita cuando CUALQUIER grupo coincide (O). Déjalo vacío para que el campo esté siempre habilitado.',
    'conditions_saved' => 'Condiciones guardadas.',
    'cond_this_entity_fields' => 'Campos de esta entidad',
    'cond_this_entity_relationships' => 'Relaciones de esta entidad',
    'cond_fields_on' => 'Campos de %s',
    'cond_or' => 'O',
    'cond_and' => 'Y',
    'cond_add_and' => '+ Agregar condición (Y)',
    'cond_add_or_group' => '+ Agregar grupo de condiciones (O)',
    'cond_remove_group' => 'Quitar grupo',
    'cond_value_placeholder' => 'Valor',
    'op_equals' => 'es igual a',
    'op_not_equals' => 'es diferente de',
    'op_greater_than' => 'es mayor que',
    'op_greater_or_equal' => 'es mayor o igual que',
    'op_less_than' => 'es menor que',
    'op_less_or_equal' => 'es menor o igual que',
    'op_contains' => 'contiene',
    'op_is_null' => 'está vacío / es nulo',
    'op_is_not_null' => 'no está vacío / no es nulo',
];
