...
return [
    ...
    'never' => 'Never',
    'just_now' => 'Just now',
    'online_users_hint' => 'Shows every user account and whether they currently have an active session in the app. This page refreshes automatically.',
    'time_years_one' => '%d year ago',
    'time_years_other' => '%d years ago',
    'time_months_one' => '%d month ago',
    'time_months_other' => '%d months ago',
    'time_days_one' => '%d day ago',
    'time_days_other' => '%d days ago',
    'time_hours_one' => '%d hour ago',
    'time_hours_other' => '%d hours ago',
    'time_minutes_one' => '%d minute ago',
    'time_minutes_other' => '%d minutes ago',
    'add_row' => 'Add new',
    'edit_row' => 'Edit',
    'view_row' => 'View',
    'delete_row' => 'Delete',
    ...
    // Admin: field-enable conditions
    'conditions' => 'Conditions',
    'field_conditions' => 'Field conditions',
    'field_conditions_hint' => 'Optionally enable this field only when certain conditions are met. Add one or more condition groups below - a group matches when ALL of its conditions are true (AND); the field is enabled when ANY group matches (OR). Leave empty to always enable the field.',
    'conditions_saved' => 'Conditions saved.',
    'cond_this_entity_fields' => "This entity's fields",
    'cond_this_entity_relationships' => "This entity's relationships",
    'cond_fields_on' => 'Fields on %s',
    'cond_or' => 'OR',
    'cond_and' => 'AND',
    'cond_add_and' => '+ Add condition (AND)',
    'cond_add_or_group' => '+ Add condition group (OR)',
    'cond_remove_group' => 'Remove group',
    'cond_value_placeholder' => 'Value',
    'op_equals' => 'equals',
    'op_not_equals' => 'is different from',
    'op_greater_than' => 'is greater than',
    'op_greater_or_equal' => 'is greater than or equal to',
    'op_less_than' => 'is less than',
    'op_less_or_equal' => 'is less than or equal to',
    'op_contains' => 'contains',
    'op_is_null' => 'is empty / null',
    'op_is_not_null' => 'is not empty / not null',
];
